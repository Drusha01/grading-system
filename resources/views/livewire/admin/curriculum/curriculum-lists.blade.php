                                ...
                                <th scope="row" class="px-4">{{($table_data->currentPage()-1)*$table_data->perPage()+$key+1 }}</th>
                                    ...
                                    <td class="px-4">
                                        <div class="d-flex justify-content-center gap-2">
                                            <a target="_blank" href="{{ route('curriculum-lists-enrolled',$value->id) }}" class="btn btn-outline-secondary d-flex justify-content-center items-center" wire:wire:navigate>
